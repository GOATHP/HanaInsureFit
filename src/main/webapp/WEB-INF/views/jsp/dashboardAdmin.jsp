                                ...
                                <div class="row no-gutters align-items-center">
                                    <div class="col mr-2">
                                        <div class="text-xs font-weight-bold text-info text-uppercase mb-1"
                                             style="color : black !important;font-size: 16px;font-weight: bold !important;">보험 가입률
                                        </div>
                                        <div class="row no-gutters align-items-center">
                                            <div class="col-auto">
                                                <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800">38.4%</div>
                                            </div>
<%--                                            <div class="col">--%>
...
<%--                        &lt;%&ndash;                                        Primary&ndash;%&gt;--%>
<%--                        &lt;%&ndash;                                        <div class="text-white-50 small">#4e73df</div>&ndash;%&gt;--%>
<%--                        &lt;%&ndash;                                    </div>&ndash;%&gt;--%>
<%--                        &lt;%&ndash;                                </div>&ndash;%&gt;--%>
<%--                        &lt;%&ndash;                            </div>&ndash;%&gt;--%>
<%--                        &lt;%&ndash;                            <div class="col-lg-6 mb-4">&ndash;%&gt;--%>
...
<%--                        &lt;%&ndash;                                    <div class="card-body">&ndash;%&gt;--%>
<%--                        &lt;%&ndash;                                        Success&ndash;%&gt;--%>
<%--                        &lt;%&ndash;                                        <div class="text-white-50 small">#1cc88a</div>&ndash;%&gt;--%>
<%--                        &lt;%&ndash;                                    </div>&ndash;%&gt;--%>
<%--                        &lt;%&ndash;                                </div>&ndash;%&gt;--%>
<%--                        &lt;%&ndash;                            </div>&ndash;%&gt;--%>
<%--                        &lt;%&ndash;                            <div class="col-lg-6 mb-4">&ndash;%&gt;--%>
...
<%--                        &lt;%&ndash;                            </div>&ndash;%&gt;--%>
<%--                        &lt;%&ndash;                            <div class="col-lg-6 mb-4">&ndash;%&gt;--%>
<%--                        &lt;%&ndash;                                <div class="card bg-light text-black shadow">&ndash;%&gt;--%>
<%--                        &lt;%&ndash;                                    <div class="card-body">&ndash;%&gt;--%>
<%--                        &lt;%&ndash;                                        Light&ndash;%&gt;--%>
<%--                        &lt;%&ndash;                                        <div class="text-black-50 small">#f8f9fc</div>&ndash;%&gt;--%>
<%--                        &lt;%&ndash;                                    </div>&ndash;%&gt;--%>
<%--                        &lt;%&ndash;                                </div>&ndash;%&gt;--%>
<%--                        &lt;%&ndash;                            </div>&ndash;%&gt;--%>
<%--                        &lt;%&ndash;                            <div class="col-lg-6 mb-4">&ndash;%&gt;--%>
<%--                        &lt;%&ndash;                                <div class="card bg-dark text-white shadow">&ndash;%&gt;--%>
<%--                        &lt;%&ndash;                                    <div class="card-body">&ndash;%&gt;--%>
<%--                        &lt;%&ndash;                                        Dark&ndash;%&gt;--%>
<%--                        &lt;%&ndash;                                        <div class="text-white-50 small">#5a5c69</div>&ndash;%&gt;--%>
<%--                        &lt;%&ndash;                                    </div>&ndash;%&gt;--%>
<%--                        &lt;%&ndash;                                </div>&ndash;%&gt;--%>
<%--                        &lt;%&ndash;                            </div>&ndash;%&gt;--%>
<%--                        &lt;%&ndash;                        </div>&ndash;%&gt;--%>
...
<%--                        <!-- Approach -->--%>
<%--                        &lt;%&ndash;                        <div class="card shadow mb-4">&ndash;%&gt;--%>
<%--                        &lt;%&ndash;                            <div class="card-header py-3">&ndash;%&gt;--%>
<%--                        &lt;%&ndash;                                <h6 class="m-0 font-weight-bold text-primary">Development Approach</h6>&ndash;%&gt;--%>
<%--                        &lt;%&ndash;                            </div>&ndash;%&gt;--%>
<%--                        &lt;%&ndash;                            <div class="card-body">&ndash;%&gt;--%>
<%--                        &lt;%&ndash;                                <p>SB Admin 2 makes extensive use of Bootstrap 4 utility classes in order to reduce&ndash;%&gt;--%>
<%--                        &lt;%&ndash;                                    CSS bloat and poor page performance. Custom CSS classes are used to create&ndash;%&gt;--%>
<%--                        &lt;%&ndash;                                    custom components and custom utility classes.</p>&ndash;%&gt;--%>
<%--                        &lt;%&ndash;                                <p class="mb-0">Before working with this theme, you should become familiar with the&ndash;%&gt;--%>
<%--                        &lt;%&ndash;                                    Bootstrap framework, especially the utility classes.</p>&ndash;%&gt;--%>
<%--                        &lt;%&ndash;                            </div>&ndash;%&gt;--%>
<%--                        &lt;%&ndash;                        </div>&ndash;%&gt;--%>
